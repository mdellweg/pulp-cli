    ...
    def test_extracts_cookies(
        ...
        headers = CIMultiDict(
            (
                ...
                (
                    "set-cookie",
                    "csrftoken=DEADBEEFDEADBEEFDEADBEEF; expires=Wed, 26 May 2027 13:22:50 GMT; Max-Age=31449600; Path=/; SameSite=Lax",
                ),
                (
                    "set-cookie",
                    "sessionid=notsosecretonlyfortestpurpose; expires=Wed, 10 Jun 2026 13:22:50 GMT; HttpOnly; Max-Age=1209600; Path=/; SameSite=Lax",
                ),
            )
        )
        ...
        assert provider._cookiejar == {
            ...
            "sessionid": Cookie(
                name="sessionid",
                value="notsosecretonlyfortestpurpose",
