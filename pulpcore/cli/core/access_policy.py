...
from pulpcore.cli.common.generic import href_option, list_command, load_json_callback, show_command
...
update_options = [
    ...
    click.option("--permissions_assignment", callback=load_json_callback),
]
